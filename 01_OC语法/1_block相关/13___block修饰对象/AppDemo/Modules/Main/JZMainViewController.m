...
//    NSLog(@"end");
    ...
    Person *p = [Person new];
    NSLog(@"p new = %ld",CFGetRetainCount((__bridge CFTypeRef)(p)));
//    __block Person *blockP = p;
    //    __block __strong Person *blockP = p;
    __block __weak Person *blockP = p;
    MyBlock block = ^{
        NSLog(@"%@",blockP);
    };
    NSLog(@"p block = %ld",CFGetRetainCount((__bridge CFTypeRef)(p)));
    block();
    NSLog(@"end");
}
@end
