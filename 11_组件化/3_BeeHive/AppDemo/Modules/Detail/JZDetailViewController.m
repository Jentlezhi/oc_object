...
//使用宏注册
@BeeHiveService(JZDetailServiceProtocol,JZDetailViewController)
...
- (UIViewController *)featchDetailVCWithInfo:(NSString *)info valueCallback:(void (^)(NSString *))callBack {
    JZDetailViewController *detail = [JZDetailViewController new];
    detail.info = info;
