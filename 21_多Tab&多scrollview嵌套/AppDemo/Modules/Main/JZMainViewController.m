...
- (UIButton *)jumpBtn {
    if (!_jumpBtn) {
        _jumpBtn = [self createBtnWithTitle:@"跳转" fontSize:16.f titleColor:UIColor.blackColor action:@selector(jumpToMultipleScrollView)];
    }
    return _jumpBtn;
}
- (UIButton *)btn1 {
...
- (void)jumpToMultipleScrollView {
    MultipleScrollViewController *mulVC = [MultipleScrollViewController new];
